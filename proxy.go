...
func clearCookie(w http.ResponseWriter, cookies []string) {
	for i := range cookies {
...
func (self *ProxyEx) proxyHandler(w http.ResponseWriter, r *http.Request) {
...
func (self *ProxyEx) handleHttp(w http.ResponseWriter, r *http.Request) {
	if self.localHandler(w, r) {
		return
	}
	...
	if cookies != nil {
		clearCookie(w, cookies)
		w.Header().Set("Content-type", "application/json")
		io.WriteString(w, GetResponse(200, "success"))
		return
	}
...
func (self *ProxyEx) beforeRequest(w http.ResponseWriter, r *http.Request) bool {
	self.logRequest(r)
	if self.BeforeRequest != nil {
		return self.BeforeRequest(w, r)
	}
	return false
}
